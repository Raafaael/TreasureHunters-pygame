...
class Wave(pygame.sprite.Sprite):
    def __init__(self, x, y, type):
        ...
        if type == 'W':
            for i in range(1, 4):
                original_image = pygame.image.load(f'sprites/water/{i}.png')
                scaled_image = pygame.transform.scale(original_image, (64, 64))  # Ajuste aqui para a largura e altura desejadas
